...
You should be able to answer most questions with either one line or a couple of lines of code, and just a few methods. If you're writing a long, complex solution, there's probably a better way.
...
**Quick tip**: to run a single example, you can run `rspec questions_spec.rb:LINE_NUMBER`

E.g. to run the first test only, you can run `rspec questions_spec.rb:6` (or `7`, `8`, `9`) as the test spans all of those lines.
